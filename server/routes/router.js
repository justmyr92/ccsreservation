...
router.patch("/announcements/:announcement_id", async (req, res) => {
    try {
...
router.delete("/announcements/:announcement_id", async (req, res) => {
    try {
        const { announcement_id } = req.params;
...
router.get("/reservation_food/:reservation_id", async (req, res) => {
    try {
        const result = await pool.query(
...
// router.post("/foods", upload.single("food_image"), async (req, res) => {
...
router.post("/reservation_count", async (req, res) => {
    try {
        const { client_id } = req.body;
...
router.get("/reservations/client/:client_id", async (req, res) => {
    try {
        const { client_id } = req.params;
...
router.post("/adds_on", async (req, res) => {
    try {
...
router.get("/adds_on/:reservation_id", async (req, res) => {
    try {
        const result = await pool.query(
...
//update status
router.patch("/update-reservation-status/:reservationId", async (req, res) => {
    try {
...
router.patch("/update-reservation/:reservationId", async (req, res) => {
    try {
        const { reservationId } = req.params;
...
router.post("/reservation_food", async (req, res) => {
    try {
...
router.get("/ratings/:reservation_id", async (req, res) => {
    try {
        const { reservation_id } = req.params;
        const result = await pool.query(
...
router.get("/payment_amount", async (req, res) => {
    try {
        const result = await pool.query(
...
router.get("/client_count", async (req, res) => {
    try {
...
router.get("/reservation_count", async (req, res) => {
    try {
        const result = await pool.query(
...
router.get("/menu_count", async (req, res) => {
    try {
...
//delete food
router.delete("/foods/:food_id", async (req, res) => {
    try {
...
router.get("/event_reservation_rating/:client_id", async (req, res) => {
    try {
        const { client_id } = req.params;
        const result = await pool.query(
...
router.get("/food_types/:food_type", async (req, res) => {
    try {
...
//get all types of foods distinct
router.get("/distinct/food_types", async (req, res) => {
    try {
        const result = await pool.query(
...
router.get("/status_count", async (req, res) => {
    try {
        const result = await pool.query(
...
router.get("/balance/:reservation_id", async (req, res) => {
    try {
        const { reservation_id } = req.params;
