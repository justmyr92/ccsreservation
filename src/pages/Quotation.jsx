...
const Quotation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {
      ...
      transaction_time: new Date().toISOString().split("T")[1].split(".")[0],
              ...
              {reservation && (
                <>
                  <tr>
                    <td>Client Name:</td>
                    <td>
                      {reservation.client_fname} {reservation.client_lname}
                    </td>
                  </tr>
                  <tr>
              ...
              )}
              {
                <>
                  ...
                  <tr>
                    ...
                    <td>
                      {event.event_date &&
                        event.event_date.split("T")[0] + " " + event.event_time}
                    </td>
                  </tr>
                  <tr>
                    <td>Event Venue:</td>
                ...
                foods.map((food) => (
                  <tr>
                    ...
                    {reservedFoods &&
                      reservedFoods.map(
                        (reservedFood) =>
                          reservedFood.food_id === food.food_id && (
          ...
          <div className="btn__container p-5 flex flex-row justify-end gap-2">
            ...
            <dialog id="my_modal_1" className="modal">
              <div className="modal-box">
                <h3 className="font-bold text-lg">Set Payment</h3>
