        ...
        <div className="container mx-auto py-20 h-content flex justify-center items-center min-h-screen">
          <div className="reservation-container p-6 w-[60%] bg-white">
            <div className="reservation-header">
              <h1 className="text-3xl font-bold text-start">Reservation</h1>
                  ...
                  steps.map((step, index) => {
                    return (
                      <li
                        key={index}
                        className={`step ${
                          index + 1 === stepCount ? "step-primary" : ""
                        }`}
                      >
              ...
              {stepCount === 1 ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-6 gap-4">
                    ...
                    <div className="form-control w-full col-span-2">
                      <label className="label">
                        <span className="label-text">Event Theme</span>
                      </label>
                      <input
                        type="text"
                        placeholder="Event Theme"
                        className={`input input-bordered w-full focus:outline-none outline-none ${
                          error && eventTheme === "" ? "input-error" : ""
                        }`}
                        name="eventTheme"
                        value={eventTheme}
                    ...
                    <div className="form-control w-full col-span-2">
                      <label className="label">
                        <span className="label-text">Event Motif</span>
                      </label>
                      <input
                        type="text"
                        placeholder="Event Motif"
                        className={`input input-bordered w-full focus:outline-none outline-none ${
                          error && eventMotif === "" ? "input-error" : ""
                        }`}
                        name="eventMotif"
                        value={eventMotif}
                    ...
                    <div className="form-control w-full col-span-2">
                      <label className="label">
                        <span className="label-text">No. of Guest:</span>
                      </label>
                      <input
                        type="number"
                        placeholder="Event Guests"
                        className={`input input-bordered w-full focus:outline-none outline-none ${
                          error && eventGuests === "" ? "input-error" : ""
                        }`}
                        name="eventGuests"
                        value={eventGuests}
                ...
                <>
                  <div className="summary-review">
                    ...
                    <p className="text-start">
                      Displayed below are the information you have provided.
                    ...
                    <div className="contact-info">
                      ...
                      <ul className="list-none text-start">
                        <li>
                          <span className="font-bold">Name:</span> {fname}{" "}
                          {lname}
                        </li>
                        <li>
                    ...
                    <div className="event-info">
                      ...
                      <ul className="list-none text-start">
                        ...
                        <li>
                          <span className="font-bold">Event Motif:</span>{" "}
                          {eventMotif}
                        </li>
                        <li>
                          ...
                          foodID.map((id, index) => {
                            return (
                              <li key={id}>
                                ...
                                {
                                  foods.find((food) => food.food_id === id)
                                    .food_name
                                }
                              </li>
                            );
            ...
            <div className="button-container flex justify-between">
              {stepCount === 1 ? (
                <Link to="/" className="btn btn-link no-underline px-0">
                  Back to Home
                </Link>
              ) : (
                <button
                  ...
                  <>
                    ...
                    <dialog id="warning_modal" className="modal">
                      <div className="modal-box">
                        ...
                        <p className="py-4">
                          You are not logged in. You will be redirected to the
                          login page by clicking the "OK" button.
                        </p>
