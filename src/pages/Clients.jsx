  ...
  useEffect(() => {
    ...
    if (search === "") {
      ...
      const filteredClients = clients.filter((client) => {
        return (
          client.client_fname.toLowerCase().includes(search.toLowerCase()) ||
          client.client_lname.toLowerCase().includes(search.toLowerCase()) ||
          client.client_email.toLowerCase().includes(search.toLowerCase()) ||
          client.client_contact.toLowerCase().includes(search.toLowerCase()) ||
          client.client_street.toLowerCase().includes(search.toLowerCase()) ||
          client.client_barangay.toLowerCase().includes(search.toLowerCase()) ||
          client.client_city.toLowerCase().includes(search.toLowerCase())
        );
      });
