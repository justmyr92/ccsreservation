...
const Dashboard = () => {
  ...
  const chartData2 = {
    labels: ["Approved", "Complete", "Rejected", "Cancelled", "Pending"],
    datasets: [
      {
        data: [30, 25, 15, 10, 20],
        backgroundColor: [
      ...
      <div className="flex flex-col w-full h-full p-6 overflow-auto">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="stats shadow mb-3 w-full">
            <div className="stat">
              ...
              {loadingProfits ? (
                ...
                <>
                  <div className="stat-value text-primary">{profits}</div>
                </>
              )}
            </div>
            <div className="stat">
              ...
              {loadingProfits ? (
                ...
                <>
                  <div className="stat-value text-primary">{client}</div>
                </>
              )}
            </div>
            <div className="stat">
              ...
              {loadingProfits ? (
                ...
                <>
                  <div className="stat-value text-primary">{menu}</div>
                </>
              )}
            </div>{" "}
            <div className="stat">
              ...
              {loadingProfits ? (
                ...
                <>
                  <div className="stat-value text-primary">{reservation}</div>
                </>
              )}
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <div className="flex flex-row justify-between items-center">
                <h1 className="text-2xl font-bold">Monthly Profits</h1>
              </div>
              <hr className="my-2" />
