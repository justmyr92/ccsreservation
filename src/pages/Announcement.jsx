        ...
        <dialog id="my_modal_4" className="modal">
          <div className="modal-box ">
            <div className="modal-action flex flex-col gap-2 m-0">
              ...
              >
                <label className="text-xl font-bold title">Title</label>
                <input
                  type="text"
                ...
                <label className="text-xl font-bold title">Annoucement</label>
                <textarea
                ...
                <input type="hidden" name="announcement_date_posted" value="" />
                <input
                  type="hidden"
                  name="reply_to"
