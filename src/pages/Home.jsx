    ...
    <>
          ...
          <div className="container mx-auto px-2 sm:px-6 lg:px-8 h-full">
            <div className="flex h-full justify-center items-center">
              <div className="hero-content max-w-xl flex flex-col items-center">
                ...
                >
                  "Calinao's Catering Services, Siguradong Quality Service at
                  Excellence "
                </p>
                <div className="flex justify-center items-center gap-2">
                  ...
                  >
                    Make a reservation <FontAwesomeIcon icon={faArrowRight} />
                  </Link>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-2 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            ...
            <p className="text-center mb-10 text-gray-900 text-lg w-3/5">
              CCS offers a wide range of catering services. See pictures below
              for further details.
            </p>
          </div>
      ...
      <section className="about py-10 bg-gray-50 w-full" id="about">
        <div className="container mx-auto px-2 sm:px-6 lg:px-8">
            ...
            {reasons.map((reason, index) => (
              ...
              >
                ...
                <h3 className="text-3xl font-bold text-orange-500 mb-2 text-start">
                  <FontAwesomeIcon icon={faPaperPlane} color="#3B82F6" />
                  {" " + reason.title}
                </h3>
          ...
          <section className=" about py-10 bg-gray-50 w-full" id="achievements">
            <div className="container mx-auto px-2 sm:px-6 lg:px-8">
              <div className="flex flex-col items-center">
                <h2 className="text-4xl font-bold mb-5 title">
                  Achievements
                  ...
                  <div className="card card-side bg-base-100 shadow-xl">
                    ...
                    <div className="card-body text-sm justify-end">
                      <h2 className="card-title">
                        BEST STANDARD QUALITY CATERING SERVICE PROVIDER
                      </h2>
                      <p className="justify-end">
                        Calinao’s Catering Services was given a trophy and
                        certificate of recognition as the BEST STANDARD QUALITY
                        CATERING SERVICE PROVIDER during the Golden Globe Annual
                        Award for Business and Excellence (GGAABE) 2019 held at
                        the Manila Hotel on September 20, 2019. This was because
                        Calinao’s Catering Services met and accepted the
                        criteria and qualifications based on the consumer survey
                        and market research conducted by the National Data
                        Research Examiner and Marketing Services Incorporated.
                        It is broadcast by the media partners, GMA 7 and PTV 4.
                      </p>
                ...
                <div className="card card-side bg-base-100 shadow-xl">
                  ...
                  <div className="card-body text-sm">
                    ...
                    <p>
                      The endeavour is a joint undertaking of Golden Globe
                      Awards Council, National Data Research and Marketing
                      Services, Inc., Philippines Best Companies Com. Inc.,
                      Sining at Gabay ng Buhay (SINAG) Foundation Inc., and
                      SINAG News Magazine. Awards are bestowed upon companies
                      that demonstrate business excellence, enhancement of
                      business performance, practices, and capabilities and
                      sharing of best choice for management practices among
                      companies. In just 3 years of existence, Calinao’s
                      Catering Services has already proven success and exemplary
          ...
          {/* Find Us Section */}
          <section className="about py-10 bg-gray-50 w-full" id="find">
            <div className="container mx-auto px-2 sm:px-6 lg:px-8">
              <div className="flex flex-col items-center">
                <h2 className="text-4xl font-bold mb-5 title">
                  Find Us
              ...
              >
                ...
                <Marker position={position}>
                  <Popup>
                    Calinao's Catering Services <br /> Sitio Ibaba, Brgy San
                    Pedro, Bauan, Batangas
                  </Popup>
                </Marker>
              </MapContainer>
            </div>
      ...
      <footer className="footer p-10 bg-sky-700 text-neutral-content">
        <aside className="flex flex-col items-start justify-center p-8 ">
          <img className="h-20 w-30 ml-10 " src={logo} alt="Calinao's Logo" />
          <p>
        ...
        <nav>
          ...
          <div className="grid grid-flow-col-flex gap-10">
            ...
            >
              <FontAwesomeIcon icon={faFacebook} size="2x" /> Calinao's Catering
              Services
            </a>
            <a
              className="flex items-center gap-2"
