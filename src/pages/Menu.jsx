            ...
            <div className="modal-action">
              ...
              >
                ...
                <input
                  ...
                  placeholder="Food Type"
                  className="input input-bordered w-full"
                  onChange={(e) => setUpdateFoodType(e.target.value)}
                ...
                <input
                  ...
                  placeholder="Food Description"
                  className="input input-bordered w-full"
                  onChange={(e) => setUpdateFoodDescription(e.target.value)}
                  value={updateFoodDescription}
                />
                <button className="btn btn-primary" type="submit">
                  Update
                </button>
                <button className="btn" onClick={handleUpdateClose}>
                  Close
                </button>
              </form>
            </div>
        ...
        <div className="table w-full p-4 bg-white rounded-lg shadow-lg">
          <div className="search-container flex justify-between items-center w-content mb-2">
            ...
            <button
              ...
              onClick={() =>
                document.getElementById("add_food_modal").showModal()
              }
            >
              <FaPlusSquare />
            </button>
