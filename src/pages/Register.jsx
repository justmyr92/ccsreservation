      ...
      <div className="container mx-auto h-full flex justify-center items-center p-20">
        <div className="form__container bg-white p-10 rounded-lg shadow-2xl">
          <div className="form__container">
            <h1 className="text-3xl font-bold text-start">Registration</h1>
            <p className="text-center">
              Please complete the following personal information to to create an
            ...
            >
              ...
              <div className="form-control w-full">
                ...
                <input
                  ...
                  onChange={(e) => setClientBarangay(e.target.value)}
                />
              </div>
              <div className="form-control w-full">
                <label className="label">
